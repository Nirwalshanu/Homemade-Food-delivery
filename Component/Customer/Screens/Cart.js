...
import {SafeAreaView, StyleSheet, View, Text, Image,TouchableOpacity,Set} from 'react-native';
      ...
      <FlatList
        ...
        ListFooterComponent={() => (
          <View>
            ...
            <TouchableOpacity style={style.buttonHover} onPress={() => { WebBrowser.openBrowserAsync('https://github.com/razorpay/react-native-razorpay');}}>
